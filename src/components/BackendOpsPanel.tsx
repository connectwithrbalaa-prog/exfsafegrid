        ...
        <div className="space-y-3">
          ...
          {briefing.isLoading ? (
            ...
            <div className="p-4 rounded-lg border border-white/[0.08] bg-white/[0.02] space-y-2">
              ...
              <div
                className="briefing-doc text-sm leading-relaxed max-h-96 overflow-y-auto"
                dangerouslySetInnerHTML={{ __html: renderMarkdown(briefing.data.markdown_text ?? briefing.data.content ?? JSON.stringify(briefing.data, null, 2)) }}
              />
            </div>
          ) : null}
        </div>
      ...
      {activeSection === "watchlist" && (
        <div className="space-y-3">
          ...
          {watchlist.isLoading ? (
            ...
            <div
              className="p-4 rounded-lg border border-white/[0.08] bg-white/[0.02] briefing-doc text-sm max-h-96 overflow-y-auto"
              dangerouslySetInnerHTML={{ __html: renderMarkdown(watchlist.data.markdown_text ?? watchlist.data.content ?? JSON.stringify(watchlist.data, null, 2)) }}
            />
          ) : null}
        </div>
      )}
